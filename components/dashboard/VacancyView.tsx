    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-6 px-1">
        <div className="flex items-center gap-2">
          ...
          <span className="text-warm-200 text-[13px] font-body">
        ...
        <div className="text-warm-400 text-[13px] font-body">
          ...
          <div key={group.id} className="card-surface overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3 border-b border-brass-faint">
              <div>
                ...
                <span className="text-warm-300 text-[13px] ml-2">{group.city}</span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-warm-200 text-[13px] font-body tabular">{group.spaces.length} vacant</span>
                <span className="text-warm-500 text-xs">·</span>
                <span className="text-warm-200 text-[13px] font-body tabular">
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="badge bg-obsidian-700 text-warm-300 border border-obsidian-600 text-[10px]">
                          {space.spaceType}
                        </span>
                      </div>
                      {space.negotiation && (
                        <div className="flex items-center gap-2 mt-1">
                          <span className="badge bg-blue-400/10 text-blue-400 border border-blue-400/20 text-[10px]">
                            negotiating
                          </span>
                          {space.negotiation.tenantId ? (
                            ...
                            <span className="text-warm-200 text-[13px] font-body">{space.negotiation.tenant}</span>
                          )}
                          <span className="text-warm-500 text-xs">·</span>
                          <span className="text-warm-200 text-[13px] font-body tabular">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <div className="text-warm-400 text-[13px] font-body">Floor {space.floor}</div>
                    </div>
